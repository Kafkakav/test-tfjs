class Webcam {
  constructor(webcamElement, facingMode = 'user', canvasElement = null, snapSoundElement = null) {
    ...
    this._vidoeTrackInfo = {width:0, height:0};
  }
  ...
  getMediaConstraints() {
      ...
      console.log(`getMediaConstraints: ${this._facingMode}`)
      videoConstraints.width = {ideal: this._webcamElement.width};
      videoConstraints.height = {ideal: this._webcamElement.height};
      var constraints = {
  ...
  selectCamera(){
    for(let webcam of this._webcamList){
      ...
      )
      {
        ...
        console.log(`selectCamera: ${webcam.label}`)
        break;
      }
    }
  }
